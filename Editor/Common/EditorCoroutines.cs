...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        /// <param name="thisReference">ReferenceVariableProperty to the instance of the class containing the method.</param>
        ...
        /// <param name="routine">The coroutine to start.</param>
        /// <param name="thisReference">ReferenceVariableProperty to the instance of the class containing the method.</param>
        public static EditorCoroutine StartCoroutine(EditorCoroutine routine, object thisReference)
        {
            CreateInstanceIfNeeded();
            return instance.GoStartCoroutine(routine.routine, thisReference);
        }
        ...
        /// <param name="routine"> The coroutine to stop.</param>
        /// <param name="thisReference">ReferenceVariableProperty to the instance of the class containing the method.</param>
        public static void StopCoroutine(EditorCoroutine routine, object thisReference)
        {
            CreateInstanceIfNeeded();
            instance.GoStopCoroutine(routine.routine, thisReference);
        }
        /// <summary>
        ...
        void GoStartCoroutine(EditorCoroutine coroutine)
        {
            ...
            // One observableAssetProperty is enough in order for "StopAllCoroutines" to work
